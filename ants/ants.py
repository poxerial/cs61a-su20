    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if self.can_contain(place.ant):
                ...
                assert False, f'Two ants in {place}'
            # END Problem 8
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while entrance_transitions <= self.max_range and not place.is_hive:
            if place.bees and entrance_transitions >= self.min_range:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        """
        # BEGIN Problem 5
        def reduce_bees_health(bees, amount):
            i = 0
            while i < len(bees):
                bee = bees[i]
        ...
        if self.health <= amount:
            reduce_bees_health(self.place.bees, amount + self.damage)
        else:
            reduce_bees_health(self.place.bees, amount)
...
class TankAnt(BodyguardAnt):
    """TankAnt provides protection to other Ants and deals damage at the same time."""
    ...
    def insects_in_front(self):
        ...
        while place != None and not place.is_hive:
            ...
            if place.ant and place.ant != self:
                ...
                if place.ant.is_container and \
                place.ant.ant_contained and place.ant.ant_contained != self:
