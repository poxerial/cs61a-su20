...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    city_coordinate = make_city('coordinate', lat, lon)
    distance_to_city_a = distance(city_coordinate, city_a)
    distance_to_city_b = distance(city_coordinate, city_b)
    if distance_to_city_a < distance_to_city_b:
