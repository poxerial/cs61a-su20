...
(define (closer-city lat lon city-a city-b)
  (define city (make-city 'name lat lon))
  (define city-a-distance (distance city city-a))
  (define city-b-distance (distance city city-b))
  (if (< city-a-distance city-b-distance)
      (get-name city-a)
      (get-name city-b)))
